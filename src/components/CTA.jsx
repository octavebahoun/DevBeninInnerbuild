    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <ScrollReveal variant="fadeDown" duration={0.5}>
          <span className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest mb-6"
        ...
        <ScrollReveal variant="fadeUp" delay={0.1} duration={0.75}>
          <h2 data-gsap-title className="font-display text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-tight"
        ...
        <ScrollReveal variant="fadeUp" delay={0.2}>
          <p className="mx-auto mt-6 max-w-xl text-sm sm:text-base font-medium leading-relaxed" style={{ color: 'var(--text-sub)' }}>
        ...
        <StaggerGroup className="mt-10 flex flex-wrap items-center justify-center gap-6" staggerDelay={0.1} delayChildren={0.45}>
          {[
            ...
            <StaggerItem key={label} variant="fadeUp">
              <div className="flex items-center gap-2 text-[10px] uppercase tracking-widest" style={{ color: 'var(--text-sub)' }}>
